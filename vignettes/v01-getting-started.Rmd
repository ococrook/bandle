...
data by using principal 

```{r loadpkgdat, message=FALSE, warning=FALSE, fig.width=4, fig.height=3}
library("pRolocdata")
data("tan2009r1")
plot2D(tan2009r1,
...
```{r alluvial, warning=FALSE, message=FALSE, fig.height=5, fig.width=3}
plotTranslocations(bandleres)
```

Or alternatively, on a chord (circos) diagram

```{r chord, warning=FALSE, message=FALSE, fig.height=4, fig.width=4}
...
```{r plottlres, warning=FALSE, fig.height=4, fig.width=4}
