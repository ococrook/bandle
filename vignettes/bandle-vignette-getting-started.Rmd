...
across all replicates and this has a nice side effect which wraps the data
into a `list`, ready for input into `bandle`.
...
We can visualise them using the `plot2D` function from `pRoloc`
