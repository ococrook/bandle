...
If we take a 1% FDR and examine how many proteins get a differential probability
greater than 0.99 we find there are 626 proteins above this threshold.
...
We can examine the top `n` proteins (here `top = 100`) and produce bootstrap estimates 
